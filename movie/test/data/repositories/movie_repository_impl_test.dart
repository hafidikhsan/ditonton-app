...
import 'package:movie/data/repositoris/movie_repository_impl.dart';
...
void main() {
  ...
  group('Now Playing Movies', () {
    ...
    test('should return error failure', () async {
      // arrange
      when(mockRemoteDataSource.getNowPlayingMovies()).thenThrow(e);
      // act
      final result = await repository.getNowPlayingMovies();
      // assert
      verify(mockRemoteDataSource.getNowPlayingMovies());
  ...
  group('Popular Movies', () {
    ...
    test('should return error failure', () async {
      // arrange
      when(mockRemoteDataSource.getPopularMovies()).thenThrow(e);
      // act
      final result = await repository.getPopularMovies();
      // assert
      verify(mockRemoteDataSource.getPopularMovies());
  ...
  group('Top Rated Movies', () {
    ...
    test('should return error failure', () async {
      // arrange
      when(mockRemoteDataSource.getTopRatedMovies()).thenThrow(e);
      // act
      final result = await repository.getTopRatedMovies();
      // assert
      verify(mockRemoteDataSource.getTopRatedMovies());
  ...
  group('Get Movie Detail', () {
    ...
    test('should return error failure', () async {
      // arrange
      when(mockRemoteDataSource.getMovieDetail(tId)).thenThrow(e);
      // act
      final result = await repository.getMovieDetail(tId);
      // assert
      verify(mockRemoteDataSource.getMovieDetail(tId));
  ...
  group('Get Movie Recommendations', () {
    ...
    test('should return error failure', () async {
      // arrange
      when(mockRemoteDataSource.getMovieRecommendations(tId)).thenThrow(e);
      // act
      final result = await repository.getMovieRecommendations(tId);
      // assert
      verify(mockRemoteDataSource.getMovieRecommendations(tId));
  ...
  group('Seach Movies', () {
    ...
    test('should return error failure', () async {
      // arrange
      when(mockRemoteDataSource.searchMovies(tQuery)).thenThrow(e);
      // act
      final result = await repository.searchMovies(tQuery);
      // assert
      verify(mockRemoteDataSource.searchMovies(tQuery));
